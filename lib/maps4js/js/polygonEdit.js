/**
 * DL changes:
 * 1) Deleting vertices is only allowed if numVertices > 3
 * 2) getStaticUrl(...) is assumed to exist
 *
 ...
 *        stopEdit()
 */
function GoogleMapsPolygonSetup2()
{
            ...
            google.maps.Polygon.prototype.runEdit = function (flag) {
                ...
                if (flag) {
                    var imgGhostVertex = new google.maps.MarkerImage(
                            getStaticUrl('maps/ghostVertex.png'), new google.maps.Size(11, 11),
                            new google.maps.Point(0, 0), new google.maps.Point(6, 6));
                    var imgGhostVertexOver = new google.maps.MarkerImage(
                            getStaticUrl('maps/ghostVertexOver.png'), new google.maps.Size(11, 11),
                            new google.maps.Point(0, 0), new google.maps.Point(6, 6));
                ...
                var imgVertex = new google.maps.MarkerImage(getStaticUrl('maps/vertex.png'),
                        new google.maps.Size(11, 11), new google.maps.Point(0, 0),
                        new google.maps.Point(6, 6));
                var imgVertexOver = new google.maps.MarkerImage(getStaticUrl('maps/vertexOver.png'),
                        new google.maps.Size(11, 11), new google.maps.Point(0, 0),
                        new google.maps.Point(6, 6));
                ...
                var vertexRightClick = function () {
                    if (self.getPath().length <= 3) { // Added by DL
                        return;
                    }
                    if (flag) {
